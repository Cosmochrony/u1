...
\begin{document}
  ...
  \begin{abstract}
    ...
    This equidistance rules out a modulus inferred from individual-generator distances.
    A separate adjacent-character calculation shows that their summed operator also has
    no uniform modulus in $\theta$; hence the equicontinuity input of the former proof is
    unavailable.
  ...
  \section{Introduction}
    ...
    \subsection{What changes in version 2.0}
      ...
      Defect~1 is fatal to the former generator-by-generator estimate and is not a matter
      of constants; a separate example below excludes a uniform modulus for the summed
      operator as well.
    ...
    \subsection{Main result}
      ...
      \begin{theorem}[Equidistance obstruction to the generator route]\label{thm:main}
        ...
        This conclusion concerns individual generators.
        The separate adjacent-character example in the discussion of
        Lemma~\ref{lem:lipschitz} shows that their summed operator also lacks a uniform
        modulus; thus the equicontinuity input used by version~1 is unavailable and
        hypothesis~[U] is not established by that route.
      \end{theorem}

      Theorem~\ref{thm:main} uses the exact computation of
      Lemma~\ref{lem:generator-perturb} for individual generators and the separate
      summed-operator example in the discussion of Lemma~\ref{lem:lipschitz}.
  ...
  \section{Proof of Theorem~\ref{thm:main}}\label{sec:proof}
    ...
    \begin{proof}[Proof of Theorem~\ref{thm:main}]
      ...
      solely from this distance through~\eqref{eq:op-stability}, that argument cannot
      supply the input.
      The adjacent-character calculation in the discussion of Lemma~\ref{lem:lipschitz}
      separately excludes a uniform modulus for the summed operator itself.
    \end{proof}
